...
แบบที่1 การอ้างอิงระดับปกติ (Normal References / Pointers)
...
`Smart Pointer ไม่ใช่แค่ตัวเลขสถาปัตยกรรมที่ชี้ไปยังตำแหน่งหน่วยความจำเหมือนพอยเตอร์ทั่วไปแต่เป็น โครงสร้างข้อมูลที่จำลองพฤติกรรมของพอยเตอร์ โดยมีคุณลักษณะเด่น 3 ประการ:
...
การซ่อนความซับซ้อน: ผู้ใช้งานสามารถเรียกใช้ข้อมูลผ่าน Smart Pointer ได้เสมือนเป็นตัวแปรธรรมดา โดยไม่ต้องสั่งเปิด-ปิด หรือคำนวณตำแหน่งหน่วยความจำด้วยตัวเองในโค้ด`
